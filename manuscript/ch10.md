...
![Homepage with superuser](images/10_home_loggedin.png)
...
![Homepage with Bootstrap](images/10_bootstrap_home.png)
...
![Homepage with Bootstrap nav logged in](images/10_bootstrap_nav_loggedin.png)

Click on the username in the upper right hand corner--`wsv` in my case--to see the nice dropdown menu Bootstrap provides.

![Homepage with Bootstrap nav logged in and dropdown](images/10_bootstrap_nav_loggedin_dropdown.png)

If you click on the "logout" link then our nav bar changes offering links to either "log in" or "sign up."

![Homepage with Bootstrap nav logged out](images/10_bootstrap_nav_loggedout.png)
...
![Homepage mobile with hamburger icon](images/10_mobile_home.png)
...
![Homepage home margins](images/10_bootstrap/bootstrap_home_margins.png)
...
![Bootstrap login](images/10_bootstrap/login.png)
...
![Bootstrap login with new button](images/10_login_new_button.png)
...
![Updated navbar logged out](images/10_bootstrap_signup.png)
...
![Crispy signup page](images/10_crispy_signup.png)
...
![Crispy signup page green button](images/10_crispy_signup_green.png)
