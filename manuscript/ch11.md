...
![Default password reset done page](images/11_password_reset_done.png)
...
![Default change password page](images/11_change_password.png)
...
![Default password reset complete](images/11_password_reset_complete.png)
