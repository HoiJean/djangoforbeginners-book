...
![Password change](images/11_password_change.png)
...
![Password change done](images/11_password_change_done.png)
...
![New password change form](images/11_new_password_change.png)
...
![New password change done](images/11_new_password_change_done.png)
...
![Default password reset page](images/11_password_reset.png)
...
![Default password reset done page](images/11_password-change-reset/password_reset_done.png)
...
![Default change password page](images/11_password-change-reset/change_password.png)
...
![Default password reset complete](images/11_password-change-reset/password_reset_complete.png)
...
![New password reset](images/11_new_password_reset.png)
...
![New reset done](images/11_new_reset_done.png)
...
![New set password](images/11_new_set_password.png)
...
![New password reset complete](images/11_new_password_reset_complete.png)
...
![SendGrid homepage](images/11_sendgrid_homepage.png)
...
![SendGrid pricing](images/11_sendgrid_free.png)

Sign up for your free account on the next page.

![SendGrid new account](images/11_sendgrid_new_account.png)
...
![SendGrid loggedin](images/11_sendgrid_loggedin.png)
...
![Default email](images/11_default_email.png)
...
![Github Django](images/11_github_django.png)
...
![Github search](images/11_github_search.png)
...
![Password reset updated](images/11_password_reset_updated.png)
