...
Complete source code can be <a href="https://github.com/wsvincent/djangoforbeginners/tree/master/ch4-message-board-app" target="\_blank">found on Github</a>.
...
![Admin login page](/assets/images/book/04_django_admin_login.png)

Login by entering the username and password you just created. You will see the Django admin homepage next:

![Admin homepage](/assets/images/book/04_django_admin_home.png)
...
![Admin homepage updated](/assets/images/book/04_django_admin_app.png)
...
![Admin new entry](/assets/images/book/04_django_admin_first_entry.png)
...
![Admin new entry](/assets/images/book/04_django_admin_post_object.png)
...
![Admin new entry](/assets/images/book/04_django_admin_post_str.png)
...
![Homepage with posts](/assets/images/book/04_homepage_helloworld.png)
...
![Admin entry](/assets/images/book/04_django_admin_second_entry.png)

![Admin entry](/assets/images/book/04_django_admin_third_entry.png)

![Updated admin entries section](/assets/images/book/04_django_admin_three_entries.png)

If you return to the homepage you'll see it automatically displays our formatted posts. Woohoo!

![Homepage with three entries](/assets/images/book/04_django_homepage_three_entries.png)
...
You should already have a Bitbucket account from [Chapter 3: A simple app]({{ site.baseurl }}{% post_url book/2010-01-01-simple %}) so go ahead and [create a new repo](https://bitbucket.org/repo/create) which we'll call `mb-app`.

![Bitbucket create app](/assets/images/book/04_bitbucket.png)
...
![Live site](/assets/images/book/04_heroku_live.png)
...
Continue on to [Chapter 5: Blog app]({{ site.baseurl }}{% post_url book/2010-01-01-blog %}).
