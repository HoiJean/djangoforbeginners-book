...
We will use this `User` object to implement login, logout, and signup in our blog application. Complete source code can be <a href="https://github.com/wsvincent/djangoforbeginners/tree/master/ch7-blog-app-with-users" target="\_blank">found on Github</a>.
...
Continue on to [Chapter 8: Custom User Accounts]({{ site.baseurl }}{% post_url book/2010-01-01-custom-user-model %}).
